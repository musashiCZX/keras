...
class CategoryCrossing(base_layer.Layer):
  ...
  CategoryCrossing layer concatenates multiple categorical inputs into a single
  categorical output (similar to Cartesian product). The output dtype is string.
